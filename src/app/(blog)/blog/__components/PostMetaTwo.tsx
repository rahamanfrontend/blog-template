                        ...
                        <div className="post-cat">
                           <div className="post-cat-list">
                              <Link
                                 ...
                                 prefetch={true}
                              >
                                 <span className="text-primary-foreground peacockGradient btnHover mt-3 w-fit rounded-full  py-1 text-base font-normal capitalize transition-all duration-300 lg:mt-5">
                                    <span
