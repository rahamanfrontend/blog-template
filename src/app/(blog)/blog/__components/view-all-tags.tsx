   ...
   return (
      <div className="relative" ref={dropdownRef}>
         <button
            ...
            className="flex items-center gap-2 rounded-md px-4 py-2 text-primary transition-colors duration-200 hover:bg-transparent hover:text-primary/90"
         >
         ...
         {isOpen && (
            <div className="absolute z-10 mt-2 w-56 rounded-md bg-card shadow-lg">
