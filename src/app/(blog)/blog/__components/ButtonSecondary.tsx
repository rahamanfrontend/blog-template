...
const ButtonSecondary: FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        "rounded-full border border-dark_blue_ bg-transparent   font-semibold text-blog-accentduration-500 hover:bg-blog-primary hover:text-white   text-[14px]  px-6 md:px-8 py-3 md:text-base",
        { "bg-blog-primary text-white": isActive },
        className,
